...
with tab2:
    ...
    st.markdown("""
    ### 📊 분석 및 시사점
    해수면 상승은 단순한 자연 현상이 아니라 도시의 **존립 기반을 위협하는 현실**입니다.  
    에어컨 사용으로 인한 온실가스 배출은 이런 해수면 상승을 가속화하며, 결국 우리가 사는 도시와 삶의 공간에도 직접적 영향을 줍니다.  
    특히 해안 도시(부산, 상하이, 자카르타, 마이애미 등)는 침수 위험과 더불어 청소년의 생활·학습 환경까지 위협받게 됩니다.
    """)
